 ...
 * Task: `ttf2woff`.
 *
 * Creates woff files from source ttf.
 */
gulp.task( 'ttf2woff', () => {
    return gulp
        .src( config.fontSRC )
...
gulp.task(
	...
	gulp.parallel( 'styles', 'vendorsJS', 'customJS', 'images', browsersync, () => {
		...
		gulp.watch( config.watchPhpParts, reload ); // Reload on PHP file changes.
		gulp.watch( config.watchStyles, gulp.parallel( 'styles' ) ); // Reload on SCSS file changes.
		gulp.watch( config.watchJsVendor, gulp.series( 'vendorsJS', reload ) ); // Reload on vendorsJS file changes.
		gulp.watch( config.watchJsCustom, gulp.series( 'customJS', reload ) ); // Reload on customJS file changes.
		gulp.watch( config.imgSRC, gulp.series( 'images', reload ) );
        gulp.watch( config.fontSRC, gulp.series( 'ttf2woff', reload ) );
	})
);
